<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1 mt-3">
        <li
            class="menu-item {{ request()->is('dashboard/fg/*') ? 'active' : '' }} {{ request()->is('dashboard/fg/*') ? 'open' : '' }}">
        ...
        <li
            class="menu-item {{ request()->is('dashboard/wip/*') ? 'active' : '' }} {{ request()->is('dashboard/wip/*') ? 'open' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <li
            class="menu-item {{ request()->is('dashboard/material-transaction/*') ? 'active' : '' }} {{ request()->is('dashboard/material-transaction/*') ? 'open' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <li
            class="menu-item {{ request()->is('master/*') ? 'active' : '' }} {{ request()->is('master/*') ? 'open' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
