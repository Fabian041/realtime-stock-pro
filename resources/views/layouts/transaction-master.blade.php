                                        ...
                                        <div class="form-check custom-option custom-option-icon">
                                            <label class="form-check-label custom-option-content" for="customRadioSvg1">
                                                <span class="custom-option-body">
                                                    <span class="custom-option-title"> Plus </span>
                                                    <small>Transaksi yang menambah stok</small>
                                                </span>
                                                <input name="status" class="form-check-input" type="radio" value="plus" id="customRadioSvg1" checked />
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md mb-md-0 mb-2">
                                        <div class="form-check custom-option custom-option-icon">
                                            <label class="form-check-label custom-option-content" for="customRadioSvg2">
                                                <span class="custom-option-body">
                                                    <span class="custom-option-title"> Minus </span>
                                                    <small>Transaksi yang mengurangi stok</small>
                                                </span>
                                                <input name="status" class="form-check-input" type="radio" value="minus" id="customRadioSvg2" />
                                            </label>
                                        </div>
                                    </div>
                                </div>
